...
export const ChatInput = memo(
  ...
  (prevProps, nextProps) => {
    return (
      ...
      // ⚡ Bolt: Removed blocking JSON.stringify for large data arrays
      // 💡 What: Replaced deep stringification with shallow reference equality for attachments
      // 🎯 Why: JSON.stringify on base64 data blocks the main thread, causing severe UI lag during typing.
      // 📊 Impact: Significantly improves rendering performance of ChatInput by eliminating main-thread blocking during deep object comparisons.
