                  ...
                  >
                    ...
                    <div className="flex flex-col gap-3">
                      <motion.button
                        ...
                        className="w-full py-4 bg-red-600 text-white rounded-full font-bold transition-all shadow-xl shadow-red-600/20 focus-visible:ring-4 focus-visible:ring-cyan-500/50 focus-visible:outline-none"
                      >
                        Clear Everything
                      </motion.button>
                      <motion.button
                        ...
                        className="w-full py-4 bg-slate-100 dark:bg-white/5 text-slate-900 dark:text-white rounded-full font-bold transition-all focus-visible:ring-4 focus-visible:ring-cyan-500/50 focus-visible:outline-none"
                      >
                        Cancel
                      </motion.button>
                    </div>
