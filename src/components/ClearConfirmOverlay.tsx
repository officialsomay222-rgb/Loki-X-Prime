                  ...
                  >
                    ...
                    <div className="flex flex-col gap-3">
                      <motion.button
                        ...
                        className="w-full py-4 bg-red-600 focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:outline-none focus-visible:ring-offset-2 text-white rounded-full font-bold transition-all shadow-xl shadow-red-600/20"
                      >
                        Clear Everything
                      </motion.button>
                      <motion.button
                        ...
                        className="w-full py-4 bg-slate-100 dark:bg-white/5 focus-visible:ring-2 focus-visible:ring-slate-500 focus-visible:outline-none focus-visible:ring-offset-2 text-slate-900 dark:text-white rounded-full font-bold transition-all"
                      >
                        Cancel
                      </motion.button>
                    </div>
