    ...
    >
      ...
      >
        <button
          ...
          className={`w-full group relative flex items-center justify-center gap-3 bg-white text-slate-900 py-4 px-8 rounded-2xl font-bold text-lg transition-all shadow-[0_0_20px_rgba(255,255,255,0.1)] focus-visible:ring-4 focus-visible:ring-cyan-500/50 focus-visible:outline-none ${isSigningIn ? "opacity-70 cursor-not-allowed" : "hover:bg-slate-50 hover:shadow-[0_0_30px_rgba(255,255,255,0.2)] hover:scale-[1.02] active:scale-[0.98]"}`}
        >
          {isSigningIn ? (
        ...
        <div className="mt-6 flex flex-col gap-4 items-center">
            <button
                ...
                className="w-full text-slate-300 hover:text-white transition-colors text-sm font-bold uppercase tracking-widest py-3 border border-white/10 rounded-xl hover:bg-white/5 focus-visible:ring-2 focus-visible:ring-white/50 focus-visible:outline-none"
            >
                Continue as Guest
            </button>
            <button
                onClick={onClose}
                className="text-slate-400 hover:text-white transition-colors text-sm font-medium focus-visible:ring-2 focus-visible:ring-white/50 focus-visible:outline-none rounded-md px-2 py-1"
            >
                Cancel
            </button>
        </div>
