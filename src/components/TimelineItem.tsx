      ...
      {!isEditing && (
        <div className="flex items-center gap-1">
          ...
          <button
            ...
            className={`hidden md:flex p-1.5 hover:bg-slate-200 dark:hover:bg-black/50 rounded-lg transition-all opacity-0 md:group-hover:opacity-100 focus-visible:ring-2 focus-visible:ring-cyan-500 focus-visible:outline-none ${(isAwakened || effectSidebar) ? 'text-slate-500 dark:text-slate-400 hover:text-red-500 dark:hover:text-red-400' : 'text-slate-400 dark:text-[#6b6b80] hover:text-red-500 dark:hover:text-red-400'} ${isMenuOpen ? 'hidden' : ''}`}
          >
          ...
          <button
            ...
            aria-haspopup="true"
            className={`p-1.5 hover:bg-slate-200 dark:hover:bg-black/50 rounded-lg transition-all md:opacity-0 focus-visible:ring-2 focus-visible:ring-cyan-500 focus-visible:outline-none ${isMenuOpen ? 'opacity-100 md:opacity-100 bg-slate-200 dark:bg-black/50' : 'opacity-100 md:pointer-events-none'} ${(isAwakened || effectSidebar) ? 'text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white' : 'text-slate-400 dark:text-[#6b6b80] hover:text-slate-800 dark:hover:text-white'}`}
          >
