...
export const TimelineItem = React.memo(({
  ...
  return (
    <motion.div
      ...
      className={`group relative flex items-center justify-between px-4 py-3 rounded-lg cursor-pointer focus-visible:ring-2 focus-visible:ring-cyan-500 focus-visible:outline-none transition-all duration-300 ${
        isActive
