    ...
    if (this.state.hasError) {
      return (
        <div className="flex flex-col items-center justify-center h-full min-h-[400px] bg-slate-950 text-white p-6 text-center">
          ...
          <button 
            className="px-6 py-3 bg-white text-black rounded-xl font-bold hover:bg-slate-200 transition-all focus-visible:ring-4 focus-visible:ring-white/50 focus-visible:outline-none"
