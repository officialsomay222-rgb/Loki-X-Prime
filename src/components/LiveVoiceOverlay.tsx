          ...
          <div className="relative z-10 flex items-center gap-12 mt-auto mb-8">
            <div className="flex flex-col items-center gap-3">
              <button
                ...
                title="Hold call"
                className="w-16 h-16 rounded-full bg-neutral-800 flex items-center justify-center shadow-[0_8px_30px_rgba(0,0,0,0.5)] border border-white/5 active:scale-95 transition-transform focus-visible:ring-4 focus-visible:ring-white focus-visible:outline-none"
              >
            ...
            <div className="flex flex-col items-center gap-3">
              <button
                ...
                aria-label="End call"
                title="End call"
                className="w-16 h-16 rounded-full bg-red-600 flex items-center justify-center shadow-[0_8px_30px_rgba(220,38,38,0.4)] active:scale-95 transition-transform focus-visible:ring-4 focus-visible:ring-white focus-visible:outline-none"
              >
